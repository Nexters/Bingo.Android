...
public class TabFirstIn extends Fragment {
    ...
    public static TabFirstIn newInstance(String foodname, int count, String boughtdate, String expirydate) {
        TabFirstIn fragment = new TabFirstIn();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int count = pref.getValue(CONST_STRINGS.FREEZER_IN_ROW_CNT, 0);
