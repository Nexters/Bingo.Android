...
public class TabSecondDoor extends Fragment {
    ...
    public static TabSecondDoor newInstance(String foodname, int count, String boughtdate, String expirydate) {
        TabSecondDoor fragment = new TabSecondDoor();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int count = pref.getValue(CONST_STRINGS.FRIDGE_DOOR_ROW_CNT, 0);
