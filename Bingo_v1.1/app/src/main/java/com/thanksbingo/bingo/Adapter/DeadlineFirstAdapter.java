...
public class DeadlineFirstAdapter extends ArrayAdapter<Food> {
    ...
    public DeadlineFirstAdapter(Context context, ArrayList<Food> foodList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        chk_deadline.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CheckBox cb = (CheckBox) v ;
                Food f = (Food) cb.getTag();
        ...
        if(calDeadline(food.getExpiryDate()) == 1){
